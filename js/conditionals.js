...
//     alert("Your lucky number is " + luckyNumber + "." + "\n" + "Your price before discount is $" + totalBill + "." + "\n" + "Your price after discount is $" + parseFloat(calculateTool(luckyNumber, totalBill)).toFixed(2) + ".");
    ...
    let userNumberConfirm = confirm("Would you like to enter a number?")

    function userNumberConfirmPromptFunction (x){
        console.log(x);
        if (x) {
            ...
            console.log("userNumber = " + userNumber);
                if (isNaN(parseFloat(userNumber))){
                    ...
                    (parseFloat(userNumber) % 2 === 0) ? alert("Your number is even!") : alert("Your number is odd!");
                    alert("Your number plus 100 is : " + (parseFloat(userNumber) + 100));
                    (parseFloat(userNumber) < 0) ? alert("Your number is negative!") : alert("Your number is positive!");
                }
        } else {
            alert("Fine, I didn't want your numbers anyway.");
        }
    }
    userNumberConfirmPromptFunction(userNumberConfirm);
