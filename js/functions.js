...
(function () {
     ...
     */
    let helloMessage = sayHello("Isaiah");
...
// and stores it in a variable named random
    ...
    console.log("The random number is two : " + isTwo(random));
    ...
    let tipPercentage = (parseFloat(prompt("What percentage would you like to tip?"))/100);
    alert("Your tip amount is $" + calculateTip(tipPercentage, billTotal).toFixed(2));
